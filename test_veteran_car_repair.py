            ...
            if line.startswith('event: analysis_result'):
                ...
                if data_line:
                    ...
                    try:
                        ...
                        print("\n分析结果：")
                        print(f"肯定部分: {data.get('positive', '')}")
                        print(f"否定部分: {data.get('negative', '')}")
                        print(f"建议部分: {data.get('suggestions', '')}")
                        
                        # 检查是否包含POLICY_A06
                        positive_content = data.get('positive', '')
                        has_policy_a06 = 'POLICY_A06' in positive_content
